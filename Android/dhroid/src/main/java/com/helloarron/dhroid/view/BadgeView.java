...
/**
 * A simple text label view that can be applied as a "badge" to any given {@link android.view.View}. This class is
 * intended to be instantiated at runtime rather than included in XML layouts.
 * 
 * @author Jeff Gilfelt
 */
public class BadgeView extends TextView
{
    ...
    public static final int POSITION_RIGHT_CENTER = 10;
     ...
     * Constructor -
     * 
     * create a new BadgeView instance attached to a target {@link android.widget.TabWidget} tab at a given index.
     * 
     * @param context context for this view.
