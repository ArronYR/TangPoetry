...
//                        }
     ...
     * @return
     */
    public JSONArray jSONArrayFromResult() {
        return jSONArrayFrom(Const.response_result);
    }
    ...
    /**
     * 获取json结果 其中result为 jsonobject
     *
     * @param prefix
     * @return
     */
    public JSONObject jSONFromResult() {
        return jSONFrom(Const.response_result);
    }
    ...
    public boolean isErrorCode() {
        if (jo != null) {
            return JSONUtil.getInt(jo, Const.response_errorCode) != 0;
        } else {
            return false;
        }
    }
    ...
    public String getErrorMsg() {
        if (jo != null) {
            return JSONUtil.getString(jo, Const.response_errorMsg);
        } else {
