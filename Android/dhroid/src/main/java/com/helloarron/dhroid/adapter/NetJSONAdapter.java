...
public class NetJSONAdapter extends BeanAdapter<JSONObject> implements
    ...
    public NetJSONAdapter(String api, Context context, int mResource, boolean isViewReuse) {
    ...
    NetTask nettask = new NetTask(mContext) {
        ...
        public void onErray(Response response) {
            ...
            if (tempLoadSuccessCallBack != null && !response.isCache()) {
        ...
        public void doInUI(Response response, Integer transfer) {
            ...
            if (list.size() == 0 || list.size() < Const.netadapter_step_default) {
                if (dialoger != null) {
                    if (!response.isCache()) {
//                        if (pageNo > 1) {
...
//        if (Const.postType == 2) {
//            if (showProgressOnLoadFrist && ignore == 0) {
//                if (NetworkUtils.isNetworkAvailable()) {
//                    progressDialoger = dialoger.showProgressDialog(mContext,
//                            "加载中");
//                }
//            }
//        } else {
